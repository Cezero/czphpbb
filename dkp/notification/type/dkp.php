...
class dkp extends \phpbb\notification\type\base
{
	...
	{
		return 'czphpbb.dkp.notification.type.dkp';
	}
	...
	{
		return $this->user->lang('CZPHPBB_DKP_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('czphpbb_dkp_controller', $this->get_data('czphpbb_dkp'));
	}
	...
	{
		$this->set_data('czphpbb_dkp', $data['czphpbb_dkp']);
