	...
	public function enable_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications->enable_notifications('eqdkp.notification.type.dkp');
				return 'notification';
	...
	public function disable_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications = $this->container->get('notification_manager');
				$phpbb_notifications->disable_notifications('eqdkp.notification.type.dkp');
				return 'notification';
	...
	public function purge_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications = $this->container->get('notification_manager');
				$phpbb_notifications->purge_notifications('eqdkp.notification.type.dkp');
				return 'notification';
